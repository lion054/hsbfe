                ...
                <div className="col-md-12">
                    <div className="sc-heading style-2">
                        <div className="content-left">
                            <div className="inner">
                                <p className="desc">Handshakebets NFTs and Wearables</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="sc-product-item style-2">
                                        <div className="product-img">
                                            ...
                                            <Link to="/connect-wallet"
                                                className="sc-button style letter"><span>Buy NFT</span></Link>
                                        ...
                                        <div className="product-content">
                                            ...
                                            <div className="product-author flex">
                                                <div className="avatar">
                                                    <img src={item.imgAuthor} alt="HandshakeBets" />
                                                </div>
                                                <div className="infor">
                                            ...
                                            <div className="product-price flex">
                                                <div className="title">NFT Value</div>
                                                <div className="price">
