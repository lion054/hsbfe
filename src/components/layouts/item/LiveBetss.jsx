        ...
        <div className="sc-product-item style-6">
                ...
                <div className="avatar-box">
                    {
                        props.item.avtList.map((item,index)=> (
                            <img key={index} src={item.img1} alt="HandshakeBets" />
                        ))
                    }
                </div>
            ...
            <div className="product-img">
                ...
                <Link to="/connect-wallet"
                    className="sc-button style letter"><span>Challange</span></Link>
            ...
            <div className="product-content">
                ...
                <div className="product-author flex">
                    <div className="avatar">
                        <img src={props.item.avt} alt="HandshakeBets" />
                    </div>
                    <div className="infor">
