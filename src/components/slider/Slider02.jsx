                        ...
                        <div className="slider-img flex">
                            <div className="img-left">
                                <div className="img-1"><img src={props.item.img1}
                                        alt="HandshakeBets" /></div>
                                <div className="img-2"><img src={props.item.img2}
                                        alt="HandshakeBets" /></div>
                            </div>
                            <div className="img-right">
                                <img src={props.item.img3} alt="HandshakeBets" />
                                <div className="box-avatar flex">
                                    <div className="list-avatar flex">
                                        <img src={props.item.avt1} alt="HandshakeBets" />
                                        <img src={props.item.avt2} alt="HandshakeBets" />
                                        <img src={props.item.avt3} alt="HandshakeBets" />
                                        <img src={props.item.avt4} alt="HandshakeBets" />
                                    </div>
